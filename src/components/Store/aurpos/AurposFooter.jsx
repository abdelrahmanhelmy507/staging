...
export default function AurposFooter() {
  ...
  const packages = [
    { name: t("اوربوس الاساسية"), href: "/aurmenu/package/start" },
    { name: t("اوربوس الفضيه"), href: "/aurmenu/package/progress" },
    { name: t("اوربوس الموسع"), href: "/aurmenu/package/excellence" },
    { name: t("اوربوس المخصص"), href: "/aurmenu/package/professional" }
  ];
              ...
              <ul className="footer-links list-unstyled">
                {packages.map((pkg, index) => (
                  <li key={index} className="mb-2">
                    <a href={pkg.href} className="footer-link">{pkg.name}</a>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div className="footer-section">
              ...
              <ul className="footer-links list-unstyled">
                {contactLinks.map((contact, index) => (
                  <li key={index} className="mb-2">
                    <a href={contact.href} className="footer-link">{contact.name}</a>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <Row className="align-items-center">
          <Col md={6} sm={12}>
            <div className="footer-bottom licence">
              <p className="mb-0">
                © {currentYear} {t("أوربوس")}. {t("جميع الحقوق محفوظة.")}
              </p>
            </div>
          </Col>
          <Col md={6} sm={12}>
            <div className="social-links text-md-end">
              <a href="#" className="social-link me-3" aria-label="Facebook"><FaFacebook /></a>
              <a href="#" className="social-link me-3" aria-label="Twitter"><FaTwitter /></a>
              <a href="#" className="social-link me-3" aria-label="Instagram"><FaInstagram /></a>
              <a href="#" className="social-link me-3" aria-label="LinkedIn"><FaLinkedin /></a>
